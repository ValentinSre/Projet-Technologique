...
(function(){
    ...
    const monQuiz1 = [
      { question: "Qu'est-ce que le SQL ?", 
        answers: { a: "Un langage pour communiquer avec une base de données", b: "Le nom technique pour désigner une donnée", c: "Le langage pour télécharger des documents" }, 
        correctAnswer: "a" }
    ];
